          ...
          <nav className="nav-footer-um">
            <ul className="list-links-footer">
              <div className="list-links-footer-x">
                <div className="list-text-links-x">
                  ...
                  <li>
                    <Link to="/receitas/clinica" id="li-design">
                      Receitas Saudáveis
                    </Link>
                  </li>
                  <li>
                    <Link to="/DicaNutri-Praia" id="li-design">
                      Dicas Alimentares
                    </Link>
                  </li>
                  <li>
                    <Link to="/sobre" id="li-design">
                      Sobre a Dra. Natália Simanoviski
                    </Link>
                  </li>
                  <li>
                    <Link to="/contato" id="li-design">
                      Fale Comigo
                    </Link>
                  </li>
                </div>
                <div className="section-footer-mobile">
                  <div className="section-pai">
                    <Botao className="button-footer-agendar">
                      Agendar Consulta
                    </Botao>
            ...
            <div className="list-links-footer-active">
              <ul className="list-links-footer">
                ...
                <li>
                  <Link to="/especialidade/esportiva" id="li-design">
                    Nutrição Esportiva
                  </Link>
                </li>
                <li>
                  <Link to="/especialidade/pediatrica" id="li-design">
                    Nutrição Pediátrica
                  </Link>
                </li>
                <li>
                  <Link to="/especialidade/clinica" id="li-design">
                    Nutrição Clínica
                  </Link>
                </li>
                <li>
                  <Link to="/especialidade/emagrecimento" id="li-design">
              ...
              <ul className="list-links-footer">
                ...
                <li>
                  <Link to="#" id="li-design">
                    Calorias e Nutrientes
                  </Link>
                </li>
                <li>
                  <Link to="/calculadoras/gasto-calorico" id="li-design">
                    Gastos Caloricos
                  </Link>
                </li>
                <li>
                  <Link to="/calculadoras/imc" id="li-design">
                    IMC e Peso Ideal
                  </Link>
                </li>
                <li>
                  <Link to="/calculadoras/consumo-agua" id="li-design">
