  ...
  return (
    <div className="dica-nutri-container">
      <div className="dica-nutri-titulo">
        ...
        <p>
          Faça escolhas inteligentes! Veja o que comer (e evitar)
          <br />
        ...
        <div className="nav-scroll-wrapper">
          <nav className="dica-nutri-nav" aria-label="Categorias">
            <NavLink
              to="/DicaNutri-Praia"
              className={({ isActive }) =>
                isActive ? "dica-nutri-btn active" : "dica-nutri-btn"
              }
            >
              <FaUmbrellaBeach />
              Praia
      ...
      <main className="dica-nutri-main">
        <p>
          Os bares costumam oferecer opções saborosas, mas é possível fazer
          escolhas mais equilibradas para não prejudicar sua saúde.
        </p>
        ...
        <section className="dica-nutri-avoid" aria-label="Evite">
          {[
            ...
            },
            {
              ...
              src: bar6,
              title:
                "Bebidas alcoólicas muito doces e calóricas (caipirinhas com açúcar refinado)",
            },
          ].map((item, index) => (
            <article className="dica-nutri-card" key={index}>
              <img src={item.src} alt={item.alt} width="60" height="60" />
