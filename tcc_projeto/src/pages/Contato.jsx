  ...
  return (
    <div className="dica-nutri-container">
      ...
      <nav className="dica-nutri-nav" aria-label="Categorias">
        <button className="dica-nutri-btn active" type="button"><FaUmbrellaBeach />Praia</button>
        <button className="dica-nutri-btn" type="button"><FaUtensils />Restaurantes</button>
        <button className="dica-nutri-btn" type="button"><FaHamburger />Fast Food</button>
        <button className="dica-nutri-btn" type="button"><FaShoppingBag />Shopping</button>
        <button className="dica-nutri-btn" type="button"><FaCocktail />Bar</button>
        <button className="dica-nutri-btn" type="button"><FaCarSide />Viagem</button>
      </nav>
