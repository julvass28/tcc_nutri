    ...
    <>
      ...
      <div className="home-comeco">
        <div className="home-bloco-inicial">
          ...
          <div className="home-bloco-texto">
            <h1>
              Te ajudo a transformar sua alimentação de forma leve e sem
              complicações!
            </h1>
            <Botao className="botao-inicial-home" to="/agendar-consulta">
              Agendar Consulta
            </Botao>
          </div>
        </div>
      ...
      <div className="sobre-nutri-mobile espacamento">
        <div className="infos-dois-home">
          ...
          <h2 className="segundo-text-home text-large-home">
            Natália Simanoviski
          </h2>
          ...
          dados={[
            {
              ...
              link: "/especialidade/clinica",
            },
            {
              id: 2,
              icone: <Iconpediatria />,
              nome: "Nutrição Pediátrica",
              link: "/especialidade/pediatrica",
            },
            {
              id: 3,
              icone: <Iconesportiva />,
              nome: "Nutrição Esportiva",
              link: "/especialidade/esportiva",
            },
            {
              id: 4,
              icone: <Iconemagrecer />,
              nome: "Emagrecimento e Obesidade",
              link: "/especialidade/emagrecimento",
            },
            {
              id: 5,
              icone: <Iconintolerancia />,
              nome: "Intolerâncias Alimentares",
              link: "/especialidade/intolerancia",
            },
          ]}
        />
      </div>
      ...
      <div className="dicas-home espacamento">
        <div
          className="imagem-container-dicas"
          data-aos="fade-right"
        ...
        >
          ...
          <div className="linha-texto-dicas">
            <p>
              ...
              Descubra as melhores e piores opções em restaurantes, fast foods e
              muito mais. Com dicas simples e práticas, você pode se alimentar
