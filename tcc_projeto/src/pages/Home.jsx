    ...
    <>
      ...
      <div className="sobre-nutri-mobile espacamento">
        ...
        <div className="infos-dois-home">
          ...
          <p className="terceiro-text-home small-home">
            Sou nutricionista <span className="color-text"> apaixonada por  transformar
        ...
        <div className="conteudo-dicas" data-aos="fade-right" data-aos-duration="2000">
          ...
          <div className="linha-texto-dicas">
            <p>
              ...
              e muito mais. Com dicas simples e práticas, você pode se alimentar
              melhor sem abrir mão do sabor.
            </p>
            <h3>Faça escolhas mais saudáveis todos os dias!</h3>
          </div>
          <Botao className="botao-verde" to="/DicaNutri-Praia" text="Ver Dicas">Ver Dicas</Botao>
        </div>
      </div>
      ...
      <div className="Receitas espacamento">
        ...
        <div className="btn-receitas-home">
          <Botao to="/receitas/clinica" text="Ver Receitas">Ver Receitas</Botao>
        </div>
      </div>
